...
def wall_follow_right_state():

    global local_x, local_y, sensor,origin_radians, start_time, prev, sumError, leftspeed, rightspeed
...
def destination_right():
    ...
    global x,y,local_x,local_y,sensor
...
def change_state():
    ...
    global curr_state, x,y,local_x,local_y, prev, sumError, leftspeed, rightspeed
...
def path_planning5(t_x,t_y):

    global local_x
    global local_y
    global local_radians
    global origin_radians
    global leftspeed
    global rightspeed
    global prev
    ...
    #load the input destination to the global variable
    x = t_x
    y = t_y
...
while True:
    ...
    control_speed(1, 1)
    time.sleep(0.1)
    path_planning5(float(x),float(y))
